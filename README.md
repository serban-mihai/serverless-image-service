...
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------ |
| `/path/image.jpg?w=500`<br>Will scale down `image.jpg` **width** to **500px** if its original width is higher, if the original width is lower, will NOT scale up, it will skip resizing maintaining aspect-ratio. Height is downscaled progressively in proportion to the new width                | ![image](https://cdn.serbanmihai.com/serverless-image-service/repo/w.jpg)      |
| `/path/image.jpg?h=500`<br>Same as above but this time comparisons and dimensions are related to `image.jpg` **heights**                                                                                                                                                                           | ![image](https://cdn.serbanmihai.com/serverless-image-service/repo/h.jpg)      |
| `/path/image.jpg?w=500&h=200`: Unless the values provided are not complementary related to the originals, this will crop `image.jpg` to be **500px width** and **200px height**. If any of the values is bigger than its original counterpart resize is skipped and the original image is returned | ![image](https://cdn.serbanmihai.com/serverless-image-service/repo/wh.jpg)     |
| `/path/image.jpg?w=500&h=200&f=contain`: Will resize the `image.jpg` **canvas to 500x200** and scale down the image mantaining proportions leaving a **black background**                                                                                                                          | ![image](https://cdn.serbanmihai.com/serverless-image-service/repo/whf.jpg)    |
| `/path/image.jpg?w=500&h=200&f=contain&p=west`: Same as above but will **align** `image.jpg` on the left of the canvas                                                                                                                                                                             | ![image](https://cdn.serbanmihai.com/serverless-image-service/repo/whfp.jpg)   |
| `/path/image.jpg?w=500&h=200&f=contain&p=west&bg={"r":0,"g":0,"b":100,"alpha":0.3}`: Same as above but the black background will match the `rgba` color in the params                                                                                                                              | ![image](https://cdn.serbanmihai.com/serverless-image-service/repo/whfpbg.jpg) |
| `/path/image.jpg?w=500&h=200&k=nearest`: Using `nearest` **kernel** to process `image.jpg`                                                                                                                                                                                                         | ![image](https://cdn.serbanmihai.com/serverless-image-service/repo/k.jpg)      |
| `/path/image.jpg?ex={"top":10,"bottom":20,"left":50,"right":10}`: Extends the image with as many px as described in each position in params. Can be chained with `bg` to give to the background a different color                                                                                  | ![image](https://cdn.serbanmihai.com/serverless-image-service/repo/ex.jpg)     |
| `/path/image.jpg?cb={"left":0,"top":0,"width":500,"height":50}`: **Crops before** resizing `image.jpg`                                                                                                                                                                                             | ![image](https://cdn.serbanmihai.com/serverless-image-service/repo/cb.jpg)     |
| `/path/image.jpg?ca={"left":0,"top":0,"width":500,"height":50}`: **Crops after** resizing `image.jpg`                                                                                                                                                                                              | ![image](https://cdn.serbanmihai.com/serverless-image-service/repo/ca.jpg)     |
| `/path/image.jpg?tr=10`: **Trims** the similar value **10 pixels** around the edges of `image.jpg`                                                                                                                                                                                                 | ![image](https://cdn.serbanmihai.com/serverless-image-service/repo/tr.jpg)     |
